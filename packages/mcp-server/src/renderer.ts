...
const RENDER_SERVICE_URL = process.env.HOLOSCRIPT_RENDER_URL || 'https://holoscript-render.onrender.com';
const PLAYGROUND_URL = process.env.HOLOSCRIPT_PLAYGROUND_URL || 'https://holoscript-render.onrender.com';
