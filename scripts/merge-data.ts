...
function merge() {
    const syntheticPath = 'c:/Users/josep/Documents/GitHub/HoloScript/final_synthetic_standardized.jsonl';
    const goldenPath = 'c:/Users/josep/Documents/GitHub/AI_Workspace/Brittney/training-data/futuristic-holoscript.jsonl';
    const outputPath = 'c:/Users/josep/Documents/GitHub/AI_Workspace/Brittney/training-data/combined_training_data.jsonl';

    const syntheticLines = fs.readFileSync(syntheticPath, 'utf8').split('\n').filter(l => l.trim());
    const goldenLines = fs.readFileSync(goldenPath, 'utf8').split('\n').filter(l => l.trim());
